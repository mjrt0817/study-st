...
- IPA公式A-1を **2021〜2025年度の5年分・150問** に拡張
- 2022年度（令和4年度春期）30問、2021年度（令和3年度春期）30問を追加
- 5年度すべて公式PDFのアプリ内表示・年度別30問採点に対応
- 年度横断復習、おすすめ10問、弱点TOP3の母集団を150問へ拡張
- ホームの回答済み件数・正答率表示を「直近5年／150問」に更新
- Supabaseテーブル・RLS・環境変数の変更なし（追加SQL不要）

### 更新方法

V3.4をV3.5のファイルで上書きしてGitHubへpushしてください。Supabase SQLの再実行は不要です。
